...
4. Save the test plan as: specs/planner.md
...
Please review:
1. Test plan from: specs/Scrum_Delete.md (for test scenarios and steps)
...
**Git Repository URL:** `https://github.com/vanndykong-dotcom/RMS--Project.git`
